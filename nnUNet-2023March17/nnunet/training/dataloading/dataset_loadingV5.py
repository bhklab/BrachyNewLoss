...
class DataLoader3D(SlimDataLoaderBase):
    ...
    def generate_train_batch(self):
        ...
        for j, i in enumerate(selected_keys):
            ...
            '''calculate dist map based on seg and calculate new label'''
            ...
            changed_all_data = np.zeros((case_all_data.shape[0], case_all_data.shape[1], case_all_data.shape[2], case_all_data.shape[3]))
            changed_all_data[:-1] = case_all_data[:-1]
