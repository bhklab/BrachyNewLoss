...
def main():
    ...
    input_folder = '/cluster/projects/radiomics/Gyn_Autosegmentation/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task055_gyn/forMCDO/images'
    output_folder = '/cluster/projects/radiomics/Gyn_Autosegmentation/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task055_gyn/forMCDO/infersTs_CE_p0.3_T20_Uts'
    part_id = 0
    num_parts = 1
    model = '3d_fullres'
    # folds = [4]
    ...
    mode = 'normal'
    all_in_gpu = 'None'
    trainer_class_name = 'nnUNetTrainerV2_OAR_distDAv2_noDS_CE_MCDO'
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not False,
                        step_size=step_size, checkpoint_name='model_final_checkpoint', mcdo=mcdo, fwd_passes=fwd_passes)
