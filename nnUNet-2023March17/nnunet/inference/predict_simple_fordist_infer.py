...
from nnunet.inference.predict_fordist import predict_from_folder
...
def main():
    ...
    input_folder = '/cluster/home/nir/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task063_gyn/imagesTs'
    output_folder = '/cluster/home/nir/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task063_gyn/infersTs_SB_distDAv2_noDS'
    part_id = 0
    num_parts = 1
    model = '3d_fullres'
    folds = [4]
    ...
    mode = 'normal'
    all_in_gpu = 'None'
    trainer_class_name = 'nnUNetTrainerV2_SB_distDAv2_noDS'
    cascade_trainer_class_name = default_cascade_trainer

    task_name = '63'
    plans_identifier = 'nnUNetPlansv2.1_ch1_cl1'
